...
namespace RYDesign.AspNetCore.JwtExtensions
{
    public static class JwtHelper
    {
        ...
        public static string CreateTokenClaim(IConfiguration configuration, List<Claim> Listclaims)
        {
            ...
            //取出私钥并以utf8编码字节输出
            var secretByte = Encoding.UTF8.GetBytes(Md5CryptUtils.Md5Encrypt(configuration["AuthenticationDemo:SecretKeyDemo"]??""));
            //使用非对称算法对私钥进行加密
            ...
            var Token = new JwtSecurityToken(
                    ...
                    expires: DateTime.UtcNow.AddMinutes(30),                      //有效期设置为2小时
